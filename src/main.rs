...
fn main() {
    ...
    prgrm[addr_start] = 0b1111000000100110;  // tinu16 dans r0
    // initialiser R1 avec la valeur 0
    prgrm[addr_start + 1] = 0b0001001001100000;  // and r1 = r1 & 0 = 0
    // stocker la valeur de R0 en memoire a l'@ stockee en r1
    prgrm[addr_start + 2] = 0b0111000001000000;  // str
    // recuperer une seconde valeur
    prgrm[addr_start + 3] = 0b1111000000100110;  // tinu16 dans r0
    // reprendre la 1e valeur de la memoire
    prgrm[addr_start + 4] = 0b0110010001000000;  // ldr
    // ajouter les 2 valeurs ensemble
    prgrm[addr_start + 5] = 0b0001000000000010;  // add r0 = r0 + r2
    // afficher l addition
    prgrm[addr_start + 6] = 0b1111000000100111;  // toutu16 r0
