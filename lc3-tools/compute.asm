...
GLOBAL_DATA_START
L1_compute .FILL lc3_L1_compute
recursive .FILL lc3_recursive
L7_compute .FILL lc3_L7_compute
L6_compute .FILL lc3_L6_compute
scanf .FILL lc3_scanf
printf .FILL lc3_printf
L5_compute .STRINGZ "Computation done : %d\n"
L4_compute .FILL #5000
L3_compute .STRINGZ "Starting computation...\n"
L9_compute .FILL #1
L2_compute .FILL #0
.END
